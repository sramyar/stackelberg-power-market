...
plot(x,zpc, type="l", col="black", pch = 0,lty=1,lwd=2.5, family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Prosumer Sales (+)/Purchase (-) (MW)",font=2, font.lab=2, cex.lab=1.65)
lines(x,zmp, type="l", pch=1, lty=4,lwd=2, col="black")
lines(x,zmpec, type="l", pch=2, lty=2,lwd=2, col="black")
abline(col="black",h=0,lty=3)
legend(80,-35, legend = c("Perfect Competition","Cournot", "Stackelberg"), col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,4,2) , cex=1.6)

plot(x,price_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Price at Prsoumer Node ($/MWh)",font=2, font.lab=2, cex.lab=1.65)
...
legend(65,45.5, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,aveprice_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Average Market Price ($/MWh)",font=2, font.lab=2, cex.lab=1.65)
lines(x,aveprice_mp, type="l", pch=22, lty=6,lwd=2, col="black")
lines(x,aveprice_mpec, type="l", pch=22, lty=2,lwd=2, col="black")
abline(col="black", lty = 3,v=106)
legend(65,35.50, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,pbenefit_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Prosumer Benefits (K$)",font=2, font.lab=2, cex.lab=1.65)
lines(x,pbenefit_mp, type="l", pch=22, lty=6,lwd=2, col="black")
lines(x,pbenefit_mpec, type="l", pch=22, lty=2,lwd=2, col="black")
abline(col="black",lty =3 ,v=106)
legend(30,13.7, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,producersurplus_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Producer Surplus (K$)",font=2, font.lab=2, cex.lab=1.65)
...
abline(col="black",lty = 3, v=106)
legend(65, 41.4, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,iso_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "ISO Revenue (K$)",font=2, font.lab=2, cex.lab=1.65)
lines(x,iso_mp, type="l", pch=22, lty=6,lwd=2, col="black")
lines(x,iso_mpec, type="l", pch=22, lty=2,lwd=2, col="black")
abline(col="black",lty = 3, v=106)
legend(65, 10, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,cs_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Consumer Surplus (K$)",font=2, font.lab=2, cex.lab=1.65)
lines(x,cs_mp, type="l", pch=22, lty=6,lwd=2, col="black")
lines(x,cs_mpec, type="l", pch=22, lty=2,lwd=2, col="black")
abline(col="black",lty = 3, v=106)
legend(65, 256.25, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,sw_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Social Surplus (K$)",font=2, font.lab=2, cex.lab=1.65)
lines(x,sw_mp, type="l", pch=22, lty=6,lwd=2, col="black")
lines(x,sw_mpec, type="l", pch=22, lty=2,lwd=2, col="black")
abline(col="black",lty = 3, v=106)
legend(65, 306.05, legend = c("Perfect Competition","Cournot", "Stackelberg"),col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)

plot(x,prosumer_pc, type="l", col="black",lty=1,lwd=2.5,family = "serif", xlab = "Prosumer's Zero Marginal Cost Renewable Output (MW)", ylab = "Prosumer Surplus (K$)",font=2, font.lab=2, cex.lab=1.65)
lines(x,prosumer_mp, type="l", pch=22, lty=6,lwd=2, col="black")
lines(x,prosumer_mpec, type="l", pch=22, lty=2,lwd=2, col="black")
abline(col="black",lty = 3, v=106)
legend(28,14.2, legend = c("Perfect Competition","Cournot", "Stackelberg"), col=c("black","black","black"),bty = "n",lwd=c(2.5,2.5,2.5), lty=c(1,6,2) , cex=1.6)
